...
Сети Петри были предложены Карлом Адамом Петри в 1962 году [@petri1962].
Задача «Обедающие философы» была сформулирована Эдсгером Дейкстрой [@dijkstra1965].
Методические указания к лабораторной работе [@lab5].
